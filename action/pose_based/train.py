...
parser.add_argument('--db_filename', type=str, default='annotations/action_annotations/ikea_annotation_db_full',
...
parser.add_argument('--dataset_path', type=str,
                    default='/media/louis/STORAGE/IKEA_ASM_DATASET/', help='path to dataset')
...
def run(init_lr=0.0001, max_steps=5e3, frames_per_clip=64, dataset_path='/media/louis/STORAGE/IKEA_ASM_DATASET/',
        train_filename='train_cross_env.txt', testset_filename='test_cross_env.txt',
        db_filename='annotations/action_annotations/ikea_annotation_db_full', logdir='',
